...
logs ( client );
let pub = "749243742820630538";
let priv = "749636553558720572"
let alone = "749636225085866074"
...
client.on ( "voiceChannelJoin" , ( member , channel ) => {
    ...
    if ( ! member.roles.cache.has ( "708753049371541584" ) ) return
    const json = {
        "channel" : channel.id ,
...
client.on ( "message" , async message => {
    ...
    const toplam = new Discord.MessageEmbed ()
       ...
       .setColor ( "RANDOM" )
        ...
        .setDescription ( `• 911 sunucusunun ses bilgileri aşağıdadır
...
client.login ( "NzQ5NjM0MzEyNjgwNTA1MzQ0.X0u1Ww.V_EiBXOfm5eaHxc7D6S2lloVM9o" );